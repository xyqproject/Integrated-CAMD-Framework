...
scalar TotGrp_U         "upper bound of total No. groups"       /5/;
...
scalar SameGrp_U        "upper bound of same groups"            /3/;

scalar Mw_U     "upper bound of molecular weight [g/Mol]"       /150/;
scalar Mw_L     "lower bound of molecular weight [g/Mol]"       /0/;
*------------------------------------------------------------------------------*
...
Execute_Unload 'step1_output_case3.gdx',nx;
Execute 'Gdxxrw step1_output_case3.gdx O = step1_output_case3.xlsx var = nx Rng =sheet1!a1:zz100000';
